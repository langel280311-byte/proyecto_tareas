...
// Usamos AbortController para poder remover todos los listeners antes de volver a añadirlos
// Esto evita que se acumulen múltiples handlers al llamar initDragAndDrop() varias veces
let dragAbortController = null;

function initDragAndDrop() {
  // Cancelamos todos los listeners del ciclo anterior antes de añadir nuevos
